...
### Build model 
model = conv_net.CNN_simple(input_size=input_size, output_size=n_classes)
...
### Save weights
model.save_weights(models_dir_path + '/Simple_CNN.h5')
...
plt.title('Confusion Matrix of a Simple CNN ', fontsize=12)
